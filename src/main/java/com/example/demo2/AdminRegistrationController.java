        ...
        registration_button.setOnAction(actionEvent -> {
            try {
                ...
                if(first_name_field.getText().equals("") || second_name_field.getText().equals("") ||
                        ...
                        login_field.getText().equals("") ||  password_field.getText().equals("") ||  dc_field.getText().equals("")){
                    ...
                    db.registration_admin(first_name_field.getText(), second_name_field.getText(), last_name_field.getText(), phone_field.getText(), login_field.getText(), password_field.getText(), Integer.parseInt(dc_field.getText()));
